...
# PEP 515: a single '_' may separate digits in float() string arguments; it is ignored.
assert_eq(float("1_000.5"), 1000.5)
assert_eq(float("-1_0.0_1"), -10.01)
assert_eq(float("1_0e1_0"), 1e11)
assert_eq(float("1e+5_0"), 1e50)
assert_eq(float("1e-5_0"), 1e-50)
assert_fails(lambda: float("_1"), "invalid float literal: _1")
assert_fails(lambda: float("1_"), "invalid float literal: 1_")
assert_fails(lambda: float("1__0"), "invalid float literal: 1__0")
assert_fails(lambda: float("1_.5"), "invalid float literal: 1_.5")
assert_fails(lambda: float("1._5"), "invalid float literal: 1._5")
assert_fails(lambda: float("1e_5"), "invalid float literal: 1e_5")
assert_fails(lambda: float("1_e5"), "invalid float literal: 1_e5")
assert_fails(lambda: float("-_1"), "invalid float literal: -_1")
assert_fails(lambda: float("i_nf"), "invalid float literal: i_nf")
