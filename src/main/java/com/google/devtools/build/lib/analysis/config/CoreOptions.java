...
public class CoreOptions extends FragmentOptions implements Cloneable {
  ...
  @Option(
      name = "distinct_exec_configuration",
      defaultValue = "true",
      documentationCategory = OptionDocumentationCategory.BUILD_TIME_OPTIMIZATION,
      effectTags = {
          OptionEffectTag.LOSES_INCREMENTAL_STATE,
      ...
      help =
          "Build all the tools used during the build for a distinct configuration from that used "
              ...
              + "exec and target programs. This may cause undesirable rebuilds of tools such as "
  ...
  public boolean useDistinctExecConfiguration;
