...
public class RemoteActionInputFetcher extends AbstractActionInputPrefetcher {
  ...
  protected boolean canDownloadFile(Path path, FileArtifactValue metadata) {
    // Unresolved symlinks don't have any contents to download, they are only planted. Note that
    // this method is also called on tree artifacts, whose metadata is of type DIRECTORY.
